...
class EnterpriseCustomerCatalog(TimeStampedModel):
    ...
    def contains_content(self, content_id_field_name, content_id_values):
        """
        Return true if this catalog contains the content items.
        ...
        Arguments:
            ...
            unique_field_values (list): The unique identifiers of the catalog content items.
