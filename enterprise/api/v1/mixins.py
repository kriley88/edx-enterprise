...
class EnterpriseCourseContextSerializerMixin(object):
    ...
    def update_course(self, course, enterprise_customer, enterprise_context):
        ...
        enterprise_utm_context = {
            ...
            'utm_source': enterprise_customer.name
        }
        ...
        course['course_runs'] = self.update_course_runs(
            ...
            enterprise_utm_context=enterprise_utm_context
        )
        ...
        if marketing_url:
            query_parameters = dict(enterprise_context, **enterprise_utm_context)
    ...
    def update_course_runs(self, course_runs, enterprise_customer, enterprise_context, enterprise_utm_context):
        """
        ...
        for course_run in course_runs:
            ...
            # Update querystring of enterprise course enrollment url with utm context.
            enrollment_url = utils.update_query_parameters(
                enterprise_customer.get_course_run_enrollment_url(course_run.get('key')), enterprise_utm_context
            )
