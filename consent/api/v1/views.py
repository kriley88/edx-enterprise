...
from consent.helpers import consent_exists, consent_provided, consent_required
...
class DataSharingConsentView(APIView):
    ...
    @classmethod
    def set_consent_state(cls, granted, username='', course_id='', enterprise_customer_uuid=None):
        """
